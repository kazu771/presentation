...
void Field::Init()
{
	...
	vertex[0].Position = D3DXVECTOR3(-50.0f, 0.0f, 50.0f);	  //左上
	...
	vertex[1].Position = D3DXVECTOR3(50.0f, 0.0f, 50.0f);	  //右上
	...
	vertex[2].Position = D3DXVECTOR3(-50.0f, 0.0f, -50.0f);	  //左下
	...
	vertex[3].Position = D3DXVECTOR3(50.0f, 0.0f, -50.0f);	  //右下
