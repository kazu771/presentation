//
//	ポリゴン2D表示用
//date:2021/11/02    name:Kazuki Wada
//
...
void Polygon2D::Init()
{
	...
	vertex[1].Position = D3DXVECTOR3(300.0f, 0.0f, 0.0f);		//右上
	...
	vertex[2].Position = D3DXVECTOR3(0.0f, 300.0f, 0.0f);		//左下
	...
	vertex[3].Position = D3DXVECTOR3(300.0f, 300.0f, 0.0f);		//右下
